...
internal fun TestScreen(
    modifier: Modifier,
    testScreenViewModel: TestViewModel,
    paddingValues: PaddingValues,
    onSignOut: () -> Unit
) {

    val state by testScreenViewModel.testScreenState.collectAsState()
    ...
    Column(
        ...
        Button(onClick = { testScreenViewModel.signOut() }) { Text(text = "Sign Out") }
